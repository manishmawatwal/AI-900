...
Automated ML is the process of automating the time-consuming, iterative tasks of ML model deployment.

Automated ML can automatically infer the training data from the use case provided.

Automated ML works by running multiple training iterations that are scored and ranked by the metrics you specify.

Automated ML enables you to specify a dataset and will automatically understand which label to predict.

Azure ML designer provides a drag-and-drop visual canvas to build, test, and deploy ML models.

Azure ML designer enables you to save your progress as a pipeline draft.

Azure ML designer enables you to include custom JavaScript functions.
...
Labeling is the process of tagging trainng data with known values.
...
Identifying brand logos is an example of natural language processing.
